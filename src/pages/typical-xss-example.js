...
export default function TypicalXssExample() {
  ...
  // or navigate to:
  // http://localhost:3000/typical-xss-example?initial=%3Cimg%20src=%22this-doesnot-exist.png%22%20onerror=%22console.log('I can run any code LOL', localStorage);%22%20style=%22display:none;%22/%3E

  return (
    <>
      <h1>Welcome to eBay</h1>
      <h2>Your product description:</h2>
      <textarea
